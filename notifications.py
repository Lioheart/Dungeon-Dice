...
from PySide2.QtCore import Qt, QRectF, QSize, Signal, QTimer
...
if __name__ == '__main__':
    import sys
    # sys.excepthook = cgitb.Hook(5, None, 5, sys.stderr, 'text')
    ...
    layout.addWidget(QPushButton(
        'Info', clicked=lambda: NotificationWindow.info('Przycisk', 'tekst')))
    layout.addWidget(QPushButton(
    ...
    layout.addWidget(QPushButton(
        'Error', w, clicked=lambda: NotificationWindow.error(
            ...
            callback=callback)))
    w.show()
    NotificationWindow.info('Przycisk', 'tekst')
    # NotificationIcon.init()
